...
*   I've settled on Q10.10 as probably OK for all internal fixed-point stuff. There's still occasionally a visual glitch (see image above) but it's pretty rare and not overly noticeable. The savings it offers in area is important to me right now, and if I find that other features added later still leave enough room, I can try pusing up to Q11.11 or whatever.
