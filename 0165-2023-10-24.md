...
*   IO[37:36] are reserved by John. Not sure why yet.
...
*   Pads I MUST have in order to access minimal SPI:
    *   /CS
    *   SCLK
    *   io0 -- technically can use just this one, in QSPI mode, but reading just 1 bit out of each nibble only.
*   Remaining: 3
*   Just using the 9 total I'm already allocated:
    *   Common to all options:
        *   CLK is an internal Caravel clock signal option.
        *   reset_xnor_a/b can be hard-wired to LA.
        *   ena from LA, too -- **abandon it maybe?**
        *   
    *   Option A:
