...
*   Created a [util (`texy.py`)](https://github.com/algofoogle/raybox-zero/blob/ew/utils/texy.py) that can be used to convert textures into the RGB222 format (and pixel packing order) used by raybox-zero.
