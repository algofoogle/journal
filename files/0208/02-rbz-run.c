...
void main()
{
    ...
    // ------------0-------------------     i_spare_0
    // -------------0------------------     i_reg_outs_enb (1=direct out, not reg'd)
    ...
    // 0000----------------------------     i_gpout3_sel=0 (default)
    // ----0---------------------------     i_debug_trace_overlay
    // -----000000---------------------     i_gpout2_sel=0 (default)
    // -----------000000---------------     i_gpout1_sel=0 (default)
    // -----------------0--------------     i_reg_mosi: 0
    // ------------------0-------------     i_reg_sclk: 0
    // -------------------0------------     i_reg_csb: 0
    // --------------------1-----------     i_debug_vec_overlay: 1 (ON)
    // ---------------------000000-----     i_gpout0_sel=0 (default)
    // ---------------------------0----     i_vec_mosi: 0
    // ----------------------------0---     i_vec_sclk: 0
    // -----------------------------0--     i_vec_csb: 0
    // ------------------------------01     i_reset_lock_b/a: differing = run (release reset)
